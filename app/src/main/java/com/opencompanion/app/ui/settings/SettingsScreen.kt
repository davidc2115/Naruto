                ...
                EngineCategory.GEMINI -> Card(Modifier.fillMaxWidth().padding(top = 4.dp)) {
                    Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        OutlinedTextField(
                            ...
                            placeholder = { Text("gemini-3.1-flash-image") },
                            singleLine = true,
                            modifier = Modifier.fillMaxWidth(),
                        )
                        Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(6.dp)) {
                            FilterChip(
                                selected = state.settings.geminiImageModelName == "gemini-3.1-flash-image",
                                onClick = { viewModel.setGeminiImageModelName("gemini-3.1-flash-image") },
                                label = { Text("Gemini Image ⭐") }
                            )
                            FilterChip(
                            ...
                            Card(
                                ...
                                Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                    Row(
                                        ...
                                        Text(
                                            "🌸 Pollinations AI (FLUX 1024x1024 Photoréaliste HD)",
                                    ...
                                    Text(
                                        "Génération directe et illimitée de photos photoréalistes, scènes détaillées et arrière-plans fidèles au scénario, tenues élégantes/lingerie et portraits (moteur FLUX via Pollinations AI). Totalement gratuit, aucune clé API ni compte requis !",
                                        style = MaterialTheme.typography.bodySmall,
                                    )
                                }
                            }

...
object RecommendedModels {
    ...
    val ALL: List<Entry> = listOf(
        ...
        Entry(
            displayName = "Llama 3.2 1B Uncensored (Q4_K_M)",
            tier = Tier.RAPIDE,
            approxSizeGb = 0.77,
            paramCount = "1 Md de paramètres",
            license = "Llama 3.2 Community License",
            downloadUrl = "https://huggingface.co/brittlewis12/Llama-3.2-1B-Instruct-Uncensored-GGUF/resolve/main/llama-3.2-1b-instruct-uncensored.Q4_K_M.gguf?download=true",
            fileName = "llama-3.2-1b-instruct-uncensored.Q4_K_M.gguf",
            note = "Version 100% non censurée et ultra-rapide (30-50 tokens/s sur GPU). Parfait pour le jeu de rôle adulte/NSFW sans latence sur mobile.",
        ),
        Entry(
            displayName = "Qwen 2.5 1.5B Abliterated (Q4_K_M)",
            tier = Tier.RAPIDE,
            approxSizeGb = 1.10,
            paramCount = "1,5 Md de paramètres",
            license = "Apache 2.0",
            downloadUrl = "https://huggingface.co/Goekdeniz-Guelmez/Josiefied-Qwen2.5-1.5B-Instruct-abliterated-v3-gguf/resolve/main/josiefied-qwen2.5-1.5b-instruct-abliterated-v3.Q4_K_M.gguf?download=true",
            fileName = "josiefied-qwen2.5-1.5b-instruct-abliterated-v3.Q4_K_M.gguf",
            note = "Modèle défiltré/abliterated très fluide, remarquable maîtrise du français et dialogues vivants sans censure.",
        ),
        Entry(
